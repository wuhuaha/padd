...
if __name__ == '__main__':
    ...
    weight_decay = 0.01
    dropout_prob = 0.1
    model_name = 'RoBERTa-zh-large'
    vocab_path = './pretrain/' + model_name  + '/vocab.txt'
    pre_params = './pretrain/' + model_name  + '/params'
    config = json.load(open('./pretrain/' + model_name  + '/roberta_config.json'))
    ...
    save_path='./outputs/' + model_name + '_' + str(lr) + '/'
    save_type='ckpt' 
    task_name = 'msra_ner'
    pred_output = save_path + 'predict/'
    ...
    pred_model_path = './outputs/ckpt.step' + str(save_steps*4)
